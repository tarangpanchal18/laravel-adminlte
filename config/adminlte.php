        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'active' => [env('ADMIN_PATH') . '/pages*'],
                ],
                [
                    'text'    => 'Website Banners',
                    'url' => env('ADMIN_PATH') . '/banner',
                    'active' => [env('ADMIN_PATH') . '/banner*'],
                ],
            ],
        ],
        [
        ...
        'AdminCustom' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'https://cdn.jsdelivr.net/npm/intl-tel-input@23.3.2/build/css/intlTelInput.css',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                ...
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => 'https://cdnjs.cloudflare.com/ajax/libs/fomantic-ui/2.9.2/semantic.min.css',
                ],
                [
                    'type' => 'css',
                    'asset' => false,
